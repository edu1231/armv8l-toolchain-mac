...
set(Qt5NetworkAuth_VERSION_STRING 5.8.1)
...
if (NOT TARGET Qt5::NetworkAuth)
    ...
    set(Qt5NetworkAuth_PRIVATE_INCLUDE_DIRS
        "${_qt5NetworkAuth_install_prefix}/include/QtNetworkAuth/5.8.1"
        "${_qt5NetworkAuth_install_prefix}/include/QtNetworkAuth/5.8.1/QtNetworkAuth"
    )
    ...
    set(_Qt5NetworkAuth_MODULE_DEPENDENCIES "Gui;Network;Core")
    ...
    foreach(_module_dep ${_Qt5NetworkAuth_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.8.1 ${_Qt5NetworkAuth_FIND_VERSION_EXACT}
    ...
    set(_Qt5NetworkAuth_LIB_DEPENDENCIES "Qt5::Gui;Qt5::Network;Qt5::Core")
    ...
    _populate_NetworkAuth_target_properties(RELEASE "libQt5NetworkAuth.a" "" )
